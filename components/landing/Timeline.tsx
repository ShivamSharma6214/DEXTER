    ...
    items: [
      {
        ...
        description:
          "A floating interface layer that sits on top of your entire desktop. Always available, never intrusive.",
      },
      {
        icon: MessageSquare,
        title: "AI Chat",
        description:
          "Converse naturally with your computer. Ask questions, get help, and receive contextual answers.",
      },
      {
        icon: Mic,
        title: "Voice Input",
        description:
          "Speak to dexter. Natural language commands, dictation, and hands-free interaction.",
      },
      {
        icon: Cpu,
        title: "Core Architecture",
        description:
          "Modular, extensible engine designed to grow with every feature added.",
      },
    ],
  },
  next: {
    ...
    items: [
      {
        ...
        description:
          "dexter sees what you see. Reads your screen, understands UI elements, and acts on visual context.",
      },
      {
        icon: Brain,
        title: "Context Awareness",
        description:
          "Knows your entire desktop state. Files, windows, clipboard, and running processes.",
      },
      {
        icon: Layers,
        title: "Memory",
        description:
          "Remembers your preferences, habits, and workflows. Gets smarter with every interaction.",
      },
      {
        icon: Puzzle,
        title: "Workflow Automation",
        description:
          "Learns your repetitive tasks and automates them. Create custom workflows with natural language.",
      },
    ],
  },
  future: {
    ...
    items: [
      {
        ...
        description:
          "Navigate the web, fill forms, and interact with web apps through natural language.",
      },
      {
        icon: Cpu,
        title: "Plugin SDK",
        description:
          "Third-party plugin ecosystem. Custom integrations. Developer SDK.",
      },
      {
        icon: Cloud,
        title: "Cloud Sync",
        description:
          "Cross-device synchronization. Settings, memories, and workflows follow you everywhere.",
      },
      {
        icon: Users,
        title: "Team Collaboration",
        description:
          "Share workflows, team-level context, and collaborative AI assistance.",
      },
    ],
  },
};
...
function StageCard({
  ...
  item: (typeof stages.current.items)[0];
  index: number;
}) {
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-24">
          ...
          >
            One milestone at a time. No artificial deadlines. Just honest
            progress toward intelligence for every computer.
          </motion.p>
        </div>
        ...
        >
          <p className="text-sm text-white/30">
            Roadmap is a living document. Priorities shift based on what early
            users actually need.
          </p>
        </motion.div>
      </div>
